# Assignment Overview: Project for Duncan Gaines

## Chocolate Pizza!!! Create a webpage from a provided design comp

Today you will be building a single webpage based off of the provided design comp assets. 
...
Get the code from the repo (repository)and clone it to your local machine using the “git clone” command.  Then use the “git checkout -b to create a new branch (type the new name after -b with a space in between the b and the branch name). After you switch to the new branch use “git push origin BRANCHNAME”.  ALWAYS push to whatever branch you are working on!  If you are working on Master, the git push origin master.  If you make a branch called “bob”, then git push origin bob.  Push the branch as soon as you make it BEFORE you start coding and then make sure it is on github before you proceed. Before starting coding, think about a strategy for approaching this project. Before writing code, think about a practical order in which to do the work:
...
OPTIONAL: Add some JavaScript functionality! Get creative, but make sure the style is complete before moving onto any additional features. Wouldn't it be super cool if you could actually check those checkboxes?

---

Submit: You'll be committing regularly and working on branches for additional Git practice. Send me a text when you are stuck, finished, or just to say “I Love You!”
